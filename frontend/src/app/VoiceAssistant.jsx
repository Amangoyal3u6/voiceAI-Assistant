    ...
    <div className='w-full max-w-3xl mx-auto px-4'>
      <div className='sticky top-0 bg-white'>
        ...
        <div className='sticky top-0 flex flex-col justify-center items-center pt-10 pb-4 bg-white'>
          ...
          <p className='mt-12 text-[15px] text-primary-blue'>
            {isRunning
              ? 'You can also end the conversation by saying "bye" or "goodbye"'
              : 'Click here to book a taxi with our assistant'
            }
          </p>
          <div className='flex items-center mt-3 gap-6'>
            <button
              className='w-48 border border-primary-blue text-primary-blue font-semibold px-4 py-1 rounded-2xl hover:bg-primary-blue/5'
              onClick={isRunning ? endConversation : startConversation}
            >
              {isRunning ? 'End conversation' : 'Book A Cab'}
            </button>
            <button
              className='h-9 w-9 flex justify-center items-center bg-primary-blue rounded-full shadow-lg hover:opacity-70 disabled:opacity-70'
